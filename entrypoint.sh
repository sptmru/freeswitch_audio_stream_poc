...
sed -i "s|ESL_INBOUND_HOST=8021|ESL_INBOUND_HOST=${ESL_INBOUND_HOST:-0.0.0.0}|" .env
sed -i "s|ESL_INBOUND_PORT=ClueCon|ESL_INBOUND_PORT=${ESL_INBOUND_PORT:-8022}|" .env
